...
4. **Customize**
   ...
   * Edit your personal info inside the HTML.
   * Adjust styles in `style.css` to match your theme.
...
If you have suggestions, design tweaks, or improvements open an **issue** or submit a **pull request**.
